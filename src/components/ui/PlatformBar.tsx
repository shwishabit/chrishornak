const platforms = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
        <path d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.908 0 3.08 0 3.768c0 .69.378 5.65.624 6.479.785 2.627 3.6 3.476 6.158 3.166-.091.014 3.61.67 3.61 3.753 0 3.282-3.834 6.815-8.392 6.815v.019h20v-.019c-4.558 0-8.392-3.533-8.392-6.815 0-3.082 3.7-3.739 3.61-3.753 2.558.31 5.373-.539 6.158-3.166C24.022 9.418 24.4 4.458 24.4 3.768c0-.69-.139-1.861-.902-2.203-.659-.299-1.664-.621-4.3 1.24C16.446 4.747 13.087 8.686 12 10.8z" />
      </svg>
    ),
  },
  {
